# Gents-N64-CIC Change-xdelta-Patches
...
The reason for these CIC Changes, are so that they can be used on a Flash / Clone Carts of a certain CIC-NUS-XXXX and Save Type.