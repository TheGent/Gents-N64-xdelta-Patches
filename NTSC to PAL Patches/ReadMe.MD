...
// This takes the original (U) release file and creates Banjo-Tooie (E) [f1] (Flashcart).z64
...
// This takes the original (U) release file and creates Jet Force Gemini (E) [f1] (Flashcart).z64
<br>
</br>
